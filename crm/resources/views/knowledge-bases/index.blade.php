...
<div class="container-fluid">
    ...
    <div class="card mt-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kbModal" onclick="prepareAddModal()">Yeni Doküman Ekle</button>
        </div>
        <div class="card-body">
            ...
            <form id="kbForm">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" id="kbTitle" class="form-control" placeholder="Örn: Fiyat Listemiz" required>
                    </div>
                    <div class="mb-3">
                        <label>Doküman İçeriği (AI bu bilgiyi kullanarak cevap üretecek)</label>
                        <textarea name="content" id="kbContent" class="form-control" rows="8" placeholder="Olası sorulara cevap verebilecek tüm detayları buraya yazınız..." required></textarea>
                    </div>
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="kbActive" name="is_active" value="1" checked>
    ...
    table = $('#kbTable').DataTable({
        ...
        columns: [
            ...
            { data: 'id', render: function(id) {
                return `
                    <button class="btn btn-sm btn-info edit-btn" data-id="${id}">Düzenle</button>
