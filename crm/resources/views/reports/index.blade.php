...
<div class="container-fluid">
    ...
    <div class="row g-3">
        ...
        <!-- Lead & Müşteri -->
        <div class="col-md-3">
            <div class="card h-100 text-center border-info border-opacity-25">
                <div class="card-body">
                    <div class="avatar-md bg-info-subtle text-info rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center">
                        <i data-lucide="users" class="fs-2"></i>
                    </div>
                    <h5 class="card-title">Müşteri & Lead Raporu</h5>
                    <p class="text-muted fs-sm">Yeni gelen lead sayıları, kaynaklar ve satın alma oranı.</p>
                </div>
                <div class="card-footer bg-transparent border-0 pt-0">
                    <a href="{{ route('reports.leads') }}" class="btn btn-outline-info w-100">Görüntüle</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card h-100 text-center border-secondary border-opacity-25">
                <div class="card-body">
                    <div class="avatar-md bg-secondary-subtle text-secondary rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center">
        ...
        <div class="col-md-3">
            <div class="card h-100 text-center border-danger border-opacity-25">
                <div class="card-body">
                    <div class="avatar-md bg-danger-subtle text-danger rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center">
        ...
        <div class="col-md-3">
            <div class="card h-100 text-center border-dark border-opacity-25">
                <div class="card-body">
                    <div class="avatar-md bg-dark-subtle text-dark rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center">
        ...
        <div class="col-md-3">
            <div class="card h-100 text-center border-primary">
                <div class="card-body">
                    <div class="avatar-md bg-primary text-white rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center shadow-lg">
                ...
                <div class="card-footer bg-transparent border-0 pt-0">
                    <a href="{{ route('reports.ai') }}" class="btn btn-primary w-100 shadow">AI Raporunu Çalıştır <i data-lucide="zap" class="ms-1 icon-sm"></i></a>
                </div>
            </div>
        </div>
